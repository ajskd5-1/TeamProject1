...
<main id="main">
		...
		<!-- 용품 사진 -->
          ...
          <div class="col-lg-6">
            <article class="blog-details">
              <h2 class="title" style="font-size: 18pt; color:#0ea2bd;">${vo.g_name }</h2>
                <div class="content">
              <blockquote>
                ...
                <br>
                 ...
                 <img src="../campgoods/brand-image.png" style="width:60px; heigh:60px;"><p2 style="font-size: 13pt; font-weight: bold;"><br> * ${vo.g_brand } *</p2>
   ...
   <div id="content" style="margin-right: 70px;">
    <div class="arrow" style="font-weight: bold;">장바구니 담기</div>
  </div>
     <div id="content" style="margin: -63.5px 70px;">
    <div class="arrow2" style="font-weight: bold;">바로 구매하기</div>
  </div>
   
   
          </div><!-- 용품 상세이미지 -->
          <hr style="color: gray; margin: 80px 0px 50px;">
