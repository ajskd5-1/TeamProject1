            ...
            <div class="u-layout-row">
              <div class="u-container-style u-layout-cell u-size-30 u-layout-cell-1" data-animation-name="customAnimationIn" data-animation-duration="1500" data-animation-delay="500">
                <div class="u-container-layout u-container-layout-1">
                  <h5 class="u-custom-font u-font-montserrat u-text u-text-default u-text-1">인기글</h5>
                  <h2 class="u-text u-text-2"> 인기글목록</h2>
                  <h4 class="u-text u-text-3"> We work directly for our clients and put client’s interests first.</h4>
              ...
              <div class="u-container-style u-layout-cell u-shape-rectangle u-size-30 u-layout-cell-2" data-animation-name="customAnimationIn" data-animation-duration="1500" data-animation-delay="500">
                <div class="u-container-layout u-container-layout-2">
                  <h5 class="u-custom-font u-font-montserrat u-text u-text-default u-text-5">공지사항</h5>
                  <h2 class="u-text u-text-6">공지사항 목록</h2>
                  <h4 class="u-text u-text-7"> We work directly for our clients and put client’s interests first.</h4>
                  <p class="u-text u-text-grey-40 u-text-8"> Everything that can be necessary to create and manage new projects (startups) in modern conditions. From development of concept, business plan and project management plan, to marketing strategy and tactics, as well as the system of customer attraction via the Internet and sales system.</p>
                </div>
              </div>
            </div>
          </div>
