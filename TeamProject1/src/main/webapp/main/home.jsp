...
<!-- ======= 메인 이미지 ======= -->
  ...
  <main id="main" style="background: linear-gradient(#FFD4AF, white); margin-top: -100px">
  
    <!-- ======= 인기 자격증 Section ======= -->
    <section class="section-services section-t8" style="margin-top: 50px;">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <div class="title-wrap d-flex justify-content-between">
              <div class="title-box">
                <h2 class="title-a">인기 자격증</h2>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row" style="margin-bottom: 50px;">
          <div class="col-md-3" style="border: solid black; padding: 10px; border-radius: 30px; margin-right: 110px;">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <div class="title-wrap d-flex justify-content-between">
              <div class="title-box">
                <h2 class="title-a">추천 교재</h2>
              </div>
              <div class="title-link">
                <a href="blog-grid.html">교재 전체보기
                  <span class="bi bi-chevron-right"></span>
                </a>
              </div>
            </div>
